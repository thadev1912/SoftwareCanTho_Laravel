...
class Carousel {
                   constructor(container, items, controls)/* this constructor are 3 paramater insert to*/ 
                  {
                          ...
                          this.myslide= setInterval(this.autoslide.bind(this),7000);
                  }
                     autoslide()
                  {
...
setauto()
{
  ...
  //  Recommend you should research about function create Element button
  setControls() {
                   this.carouselControls.forEach(control =>
                     {
                              galleryControlsContainer.appendChild(document.createElement('button')).className = `gallery-controls-${control}`;
                          //   document.querySelector(`.gallery-controls-${control}`).innerText = control; //return element control show out on html
                     });
                }
