               ...
               <div class="card-header bg-danger">
                    <div class="row">
                                  <div class="col-md-12" align="center">
                                       <h1 class="btn text-light"> DANH SÁCH PHIẾU NHẬP VẬT TƯ</h1>
                                  </div>
                                ...
                                <table class="table table-bordered ">
                                     <thread >
                                         ...
                                         <th style="text-align: center; vertical-align: middle;background: blue;color: white;width:40px;">STT </th>
                                            ...
                                            <th style="text-align: center; vertical-align: middle;background: blue;color: white;width:100px;">Kho</th>                                          
