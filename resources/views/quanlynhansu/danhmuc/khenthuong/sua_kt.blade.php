...
<div class="card-header bg-danger">
                    <div class="row">
                                  <div class="col-md-12" align="center">
                                       <h1 class="btn text-white"> SỬA THÔNG TIN KHEN THƯỞNG</h1>
                                  </div>
...
<div class="card-body">
            ...
            <div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    ...
                    <div class="col">
                        <label>SỐ TIỀN</label>
                        <input id="new-pass-control" name="txt_sotien" class="form-control" type="text" value="{!! number_format($data->sotien),'' !!} VNĐ">
                        @error('txt_sotien')
                             <span class="text-danger">{{$message}}</span>
                            @enderror    
                    </div>       
