...
<div class="card-header bg-danger">
                    <div class="row">
                                  <div class="col-md-12" align="center">
                                       <h1 class="btn text-white"> THÊM THÔNG TIN KHEN THƯỞNG</h1>
                                  </div>
...
<div class="text-white mt-2">
                    ...
                    <a href="{{URL:: route('khenthuong')}}" class="btn btn-danger"><i class="fas fa-reply-all"></i>&nbsp&nbspQuay lại&nbsp&nbsp</a>
</div>
